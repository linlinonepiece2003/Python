...
def countWords_2(inputF, outputF):
    ...
    sorted_Alpha_order  = dict(sorted(Wcounts.items(), key=lambda x: (-x[1], x[0])))

    with open(outputF, 'w') as json_file:
        json.dump(sorted_Alpha_order, json_file)
# countWords_2('E:/Code/VScode/Python/62fit3ss1_assignment2_2101140046/sample.txt', 'sample_out_3.json')       